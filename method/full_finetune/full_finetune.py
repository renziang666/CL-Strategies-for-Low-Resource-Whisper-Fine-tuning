...
def setup_training_args(args):
    return Seq2SeqTrainingArguments(
        output_dir=f"/data/share/guodong/workspace/models/finetune_whisper_trained/large_full_831",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--replay_ratio", default=0.3, type=float)
    ...
    print("独立数据集加载成功！")
    # 合并数据集
    # combined_train_data = concatenate_datasets([ds["train"], ds_ER["train"]])
    # combined_test_data = concatenate_datasets([ds["test"], ds_ER["test"]])
