...
def main():
    ...
    parser.add_argument("--num_proc", default=12, type=int)
    parser.add_argument("--replay_ratio", default=0.2, type=float)
    # ！！！最关键的参数：指定处理好的数据要存到哪里！！！
    parser.add_argument("--output_dir", default="/mnt/lv2/FLEURS2/large_cache")

    args = parser.parse_args()

    # 只需要 processor 来处理数据，不需要加载完整模型
    model_name_or_path = "/mnt/lv3/linguodong/pretrain_models/whisper_openai/whisper_large-v3"
